...
const FirstSection = () => {
  return (
    <section
      id="about"
      className="flex pt-[3rem] md:pt-16 snap-center min-h-screen w-[85%] mx-auto text-white overflow-hidden"
    >
      <div className="flex flex-col space-y-6 lg:flex-row my-auto mx-auto">
